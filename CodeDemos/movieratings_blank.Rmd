...
If $a, b$ are unknown, how do we estimate them? We're looking for the best choices of their estimators: $\hat{a}, \hat{b}$. Then we could predict the responses as $\hat{y} = \hat{a}_0 + \hat{b}_1 x$. But which values of $\hat{a}_0, \hat{b}_1$ are best?
